# Divergenios · Productos digitales vendibles

> _"Aprender es divertido"_ — STEAM con las manos, para mentes curiosas de 6 a 10 años.

Este directorio contiene la línea de **productos digitales descargables** de
divergenios.com: contenido de alta calidad, listo para vender, coherente con la
marca y pensado para los dos compradores que pagan por él: **familias** y
**docentes/colegios**.

---

## 1. Posicionamiento (la brújula de todo el catálogo)
...
(el niño entiende qué pasó y por qué).

---

## 2. Por qué un PRINTABLE es el primer producto correcto

Decidimos empezar por un **PDF imprimible** porque:

- **Margen ~100 %** y coste de producción único (se crea una vez, se vende infinitas).
- **Sirve a los dos compradores a la vez**: la familia lo imprime en casa, el
  docente lo proyecta o fotocopia para el aula.
- **Es el mejor escaparate de la marca**: demuestra calidad y genera confianza
  para venderles después el curso, la membresía y los kits.
- **Riesgo cero de devoluciones logísticas** y entrega instantánea.

Encaja en la escalera de valor de Divergenios:

```
Gratis (lead magnet)  →  PRINTABLE 7-15€  →  Curso online 39-79€  →  Membresía 9€/mes  →  Kit físico + guía 25-49€
        ↑ captas                ↑ ESTE PRODUCTO        ↑ profundizas         ↑ recurrencia        ↑ ticket alto
```
...
| Archivo | Qué es |
|---------|--------|
| `PRODUCTO.md` | Todo el contenido imprimible: bienvenida, seguridad, 20 experimentos, cuaderno del científico, diploma. |
| `GUIA-ADULTO-Y-DOCENTE.md` | Cómo facilitar, preguntas socráticas y alineación curricular (versión aula). |
...
Priorizados por encaje con la marca y facilidad de producción. El nº 1 es el de
esta entrega.
...
> licencia multi-alumno y extras docentes → maximiza ingreso sin producir de cero.

---

## 5. Estándares de calidad para cualquier producto futuro
